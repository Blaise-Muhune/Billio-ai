      ...
      .bg-white.rounded-2xl.shadow-lg.border.border-gray-100.overflow-hidden
        ...
        .relative.bg-gradient-to-r.from-emerald-500.to-teal-500.px-6.pt-12.pb-24(class="sm:px-8")
          ...
          .relative.z-10.flex.flex-col.items-center
            ...
            h1.text-3xl.font-bold.text-white.mb-2 {{ profile.displayName }}
            .flex.items-center.gap-2.text-white.bg-black.bg-opacity-20.px-4.py-2.rounded-full(v-if="profile.company || profile.title")
            ...
            .text-white.text-center.mt-4.mb-2.max-w-xl.mx-auto(v-if="profile.bio")
              p.text-sm.leading-relaxed {{ profile.bio }}

        //- Contact Information Section
        .px-6.py-8.-mt-12(class="sm:px-8")
          .bg-white.rounded-xl.shadow-lg.p-6.max-w-2xl.mx-auto
            ...
            .grid.gap-4.justify-center(
              ...
              //- Address
              .flex.flex-col.items-center.p-4.rounded-xl.bg-gray-50.text-center(v-if="hasAddress")
                .flex.items-center.justify-center.w-12.h-12.rounded-full.bg-emerald-100.mb-2
                  VaIcon(name="location_on" size="24px" class="text-emerald-600")
                .text-sm.text-gray-900.font-medium Address

        //- Social Links Section
        .px-6.pb-8(class="sm:px-8" v-if="hasSocialLinks")
          .max-w-2xl.mx-auto
            //- Using CSS Grid with auto-fit and minmax for responsive, centered layout
            .grid.gap-4.justify-center(
              class="grid-cols-2 sm:grid-cols-[repeat(auto-fit,minmax(140px,140px))] place-items-center mx-auto"
              style="max-width: 600px;"
            )
